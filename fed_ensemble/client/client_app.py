...
# Define Flower Cliendt and client_fn
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        try:
            # Set weights and verify they wdere set correctly
            ...
            # Add training progress logaging3
...
class MaliciousClient(FlowerClient):
    ...
    def fit(self, parameters, config):
        ...
        # Return manipulated weighdts and metrics
        return (
            model_weights,
            len(self.trainloader.dataset),
            {
